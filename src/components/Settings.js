            ...
            <div className="glass rounded-xl shadow-lg p-6 animate-fade-in">
              {activeTab === 'profile' && (
                <div className="space-y-6">
                  ...
                  {/* Profile Picture */}
                  <div className="flex items-center gap-6 p-6 bg-white/50 rounded-xl">
              ...
              {activeTab === 'security' && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl font-bold gradient-text">Security Settings</h2>
                  </div>
                  ...
                  <div className="p-6 bg-white/50 rounded-xl">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300"
                      ...
                      <button className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg shadow-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105">
              ...
              <div className="flex justify-end pt-6 border-t border-gray-200">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-300 transform hover:scale-105"
                >
